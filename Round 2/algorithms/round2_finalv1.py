...
class DjembesStrategy(MarketMakingStrategy):
    ...
    def __init__(self, symbol: Symbol, limit: int) -> None:
        ...
        self.tiemsteps_into_future = 50
        self.placeholder_variance = 0.05
        self.random_seed = 42

        # distribution params
        self.brownian_mean_1 = 0
        self.brownian_variance_1 = 1
        self.brownian_mean_2 = 0
        ...
        self.r = 0 # risk return (no return in our case)

        self.bias = -3806.6215702688423

    def get_price_cache(self, state: TradingState) -> list:
